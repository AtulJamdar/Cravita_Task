...
export default function StatCard({ type, value }) {
  ...
  return (
    <Card className="relative overflow-hidden flex-1 min-w-0 bg-[var(--color-bg-surface)] border border-[var(--color-border)] rounded-xl py-5 flex items-center gap-4 shadow-sm">
